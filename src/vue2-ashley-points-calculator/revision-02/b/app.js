var pointsCalculator = new Vue({
  ...
  methods: {
    ...
    SIQuizonChange: function (e) {
      ...
      // My secret hacks, whenever adding new question in the array, leave the last one as is, e.g. BIIQUiz_10 should stay as is
      const parent = document.querySelector("." + e.path[2].className);
      var lastChilds = parent.querySelectorAll(".form-group").length;
      var lastElement = document.getElementById("SIQuiz_" + lastChilds);

      var results = document.querySelector(".SIResults");
      var row =
        results.querySelector(".container").lastChild.previousElementSibling;
      row.className = "d-none";
      // end of secret hacks

      // Total Results
      this.points += parseInt(this.currentPoints);
      document.getElementsByName("SITotalPoints")[0].value = this.points;
      if (lastElement.style.display == "block") {
        lastElement.className = "d-none";
        this.SIResults = true;
      }
    },

    // SN Method
    SNQuizonChange: function (e) {
      this.currentPoints = document.getElementsByName(e.target.id)[0].value =
        event.target.value;
      ...
      // My secret hacks, whenever adding new question in the array, leave the last one as is, e.g. BIIQUiz_10 should stay as is
      const parent = document.querySelector("." + e.path[2].className);
      var lastChild = parent.querySelectorAll(".form-group").length;
      var lastElement = document.getElementById("SNQuiz_" + lastChild);

      var results = document.querySelector(".SNResults");
      var row = results.querySelector(".container").lastChild.previousSibling;
      row.className = "d-none";
      // end of secret hacks

      // Total Results
      this.points += parseInt(this.currentPoints);
      document.getElementsByName("SNTotalPoints")[0].value = this.points;
      if (lastElement.style.display == "block") {
        this.SNResults = true;
        lastElement.className = "d-none";
      }
    ...
    SRQuizonChange: function (e) {
      ...
      const parent = document.querySelector("." + e.path[2].className);
      var lastChild = parent.querySelectorAll(".form-group").length;
      var lastElement = document.getElementById("SRQuiz_" + lastChild);

      var results = document.querySelector(".SRResults");
      var row =
        results.querySelector(".container").lastChild.previousElementSibling;
      // end of secret hacks
      ...
      // Total Results
      this.points += parseInt(this.currentPoints);
      document.getElementsByName("SRTotalPoints")[0].value = this.points;
      if (lastElement.style.display == "block") {
        this.SRResults = true;
        lastElement.className = "d-none";
      }
    ...
    SWQuizonChange: function (e) {
      ...
      const parent = document.querySelector("." + e.path[2].className);
      var lastChilds = parent.querySelectorAll(".form-group").length;
      var lastElement = document.getElementById("SWQuiz_" + lastChilds);

      var results = document.querySelector(".SWResults");
      var row =
        results.querySelector(".container").lastChild.previousElementSibling;
      row.className = "d-none";
      console.log(row);
      ...
      // Total Results
      this.points += parseInt(this.currentPoints);
      document.getElementsByName("SWTotalPoints")[0].value = this.points;
      if (lastElement.style.display == "block") {
        this.SWResults = true;
        lastElement.className = "d-none";
      }
